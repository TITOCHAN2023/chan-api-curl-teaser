# Chan · Multi-model API curl teaser

Free taste: **OpenAI-compatible chat completions** curl + a tiny retry wrapper.
...
export PROMPT='Say hello in one short sentence.'
bash recipes/openai.sh
```

Or plain curl: see `recipes/openai.curl.txt`.

## What's in the paid zip

- Anthropic Messages API recipe
